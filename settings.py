...
SECRET_KEY = 'agcp-z5=+37f7!rt!wlvvu2ro7aaps@7ouh#ug-0f(@8xbtjyd'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'video_service/templates')]
        ,
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'video_service/db.sqlite3'),
    }
}
